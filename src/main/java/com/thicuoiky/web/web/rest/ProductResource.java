package com.thicuoiky.web.web.rest;

import com.thicuoiky.web.domain.Product;
import com.thicuoiky.web.service.ProductService;
...
public class ProductResource {
    ...
    public ResponseEntity<ProductDTO> createProduct(@Valid @RequestBody ProductDTO productDTO) throws Exception {
        ...
        if (productDTO.getId() != null) {
            throw new Exception("A new product cannot already have an ID" + ENTITY_NAME+ "idexists");
        }
     ...
     */
    @GetMapping("/products")
    public ResponseEntity<List<ProductDTO>> getAllProducts(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
    ...
    public ResponseEntity<?> getProductByCategory(@PathVariable Long id){
        return ResponseEntity.ok(productService.findProductsByCategoriesId(id));
    }
    /**
